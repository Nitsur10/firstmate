...
FM_SNAPSHOT_BUDGET=5                # one total seconds budget for all concurrent remote home-ledger reads and any mixed-fleet fallback started after a definitive missing ledger
...
FM_RECONCILE_REQUEST_MAX_BYTES=1048576   # maximum captured Bearings or fleet snapshot accepted as one durable reconcile-notify request
