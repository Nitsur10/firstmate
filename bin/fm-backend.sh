...
# agent-process recovery path has not been empirically validated. cmux remains
# unverified because no agent-attribution read has been validated against the
# live app, so a cmux secondmate is preserved and reported rather than
# auto-relaunched (docs/cmux-backend.md "Active limits"). Orca does not
